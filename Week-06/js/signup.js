            ...
            if (registerAdressField.value.length > 5) {
                ...
                if (parts.length >= 3) {
                    ...
                    if (hasLetter && hasNumber){
                        registerAdressField.classList.add('valid-field');
                    }else{
                        registerAdressField.classList.add('invalid-field');
                        adressError.innerText = 'The adrres must have numbers and letters.'
                    }
                }else {
                    registerAdressField.classList.add('invalid-field');
                    adressError.innerText = 'This field must have a space between therms.';
                }
            }else{
                registerAdressField.classList.add('invalid-field');
                adressError.innerText = 'This field must have at least 5 characters.';
                return;
            }
        }else {
            registerAdressField.classList.add('invalid-field');
